...
func insertData(sname string, rec map[string]any, attrs, sep, div string, updateRecord bool) (string, error) {
	...
	// add doi attributes
	doiAttributes := []string{"doi", "doi_url", "doi_user", "doi_created_at", "doi_public", "doi_provider", "doi_access_metadata", "doi_foxden_url", "doi_parents_dids", "license", "license_name", "license_uri"}
