...
func setupRouter() *gin.Engine {
	routes := []server.Route{
		...
		{Method: "GET", Path: "/tmp/records", Handler: TmpRecordsHandler, Authorized: true},
		{Method: "PUT", Path: "/tmp/record", Handler: UpdateTmpRecordHandler, Authorized: true, Scope: "write"},
